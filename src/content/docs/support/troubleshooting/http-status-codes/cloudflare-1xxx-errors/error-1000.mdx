...
- The `cf-connecting-ip` header can be disabled via a Request Header Transform[^1] rule or via a "Remove visitor IP headers" headers Managed Transform Rule[^2]

[^1] https://developers.cloudflare.com/rules/transform/request-header-modification/
[^2] https://developers.cloudflare.com/rules/transform/managed-transforms/reference/#remove-visitor-ip-headers
